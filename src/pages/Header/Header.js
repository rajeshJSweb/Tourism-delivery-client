  ...
  const signOut = () => {
    ...
    return (
        ...
        <Navbar bg="light" expand="lg">
            <Container>
                <Navbar.Brand href="/home" className='site-title'>trip<span className='medi'>BOOKING</span></Navbar.Brand>
              ...
              {
                user.email?
                <Nav.Link className="menu-item" as={Link} to="/dashboard">Dashboard</Nav.Link>:
